...
func main() {
	...
	progCmds.register("follow", handlerFollow)       //register follow handler function
	progCmds.register("following", handlerFollowing) //register following handler function
